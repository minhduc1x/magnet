...
spx = pd.read_excel(r'\\evprodfsg01\QR_Workspace\Debt Issue Study\Debt_Equity_Study_MASTER.xlsx', 'SPX', na_values=['NA'])
#%%
...
adjprices = pd.read_sql_query(priceQuery, ciqdb)
...
and [pricingDate] BETWEEN '1/1/2010' AND @evalDate
"""
